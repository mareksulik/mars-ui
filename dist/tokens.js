...
export const tokens = {
 ...
 "semantic": {
  "note": "Step semantics: 100–300 component backgrounds (default/hover/active), 400–600 borders, 700–800 high-contrast fills and lines, 900–1000 text (secondary/primary).",
  "status": {
   "ok": "green-800",
   "ok-text": "green-900",
   "warn-3": "amber-800",
